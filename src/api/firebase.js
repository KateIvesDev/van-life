...
export const vansRef = collection(db, "vans");

{/* 
await setDoc(doc(vansRef, 2), data[1])
.then(() => {
...
await setDoc(doc(vansRef, 3), data[2])
.then(() => {
  console.log('Document has been added')
})
.catch(error=> {
...
await setDoc(doc(vansRef, 4), data[3])
.then(() => {
  console.log('Document has been added')
})
.catch(error=> {
...
await setDoc(doc(vansRef, 5), data[4])
.then(() => {
  console.log('Document has been added')
})
.catch(error=> {
...
await setDoc(doc(vansRef, 6), data[5])
.then(() => {
  console.log('Document has been added')
})
.catch(error=> {
